...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.tv_hello).setOnClickListener {
           viewModel.getBannerLiveData().observe(this, Observer<HttpResut<List<Banner>>> { t -> Toast.makeText(this@MainActivity,"获取banner成功,条数:${t?.data?.size}",Toast.LENGTH_LONG).show() })
